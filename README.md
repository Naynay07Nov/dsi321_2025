...
## 3. ตัวชี้วัดความสำเร็จของโครงงาน (Key Performance Indicators)
...
__3.1 ตัวชี้วัดด้านเทคนิค (Technical KPIs)__
...
**3.2 ตัวชี้วัดด้านการศึกษา (Educational KPIs)**
- **คุณภาพเอกสาร**
...
**3.3 ตัวชี้วัดด้านการใช้งานจริง (Practical KPIs)**
...
## 4. แผนงานโครงการ (Project Plan Overview)
...
| 2          | เย็นและแห้ง    | สวมเสื้อผ้าอบอุ่น ดูแลผิวให้ชุ่มชื้น               |
 ...
 ตัวอย่าง Cluster
| Cluster | Temperature (°C) | Humidity (%) | Wind Speed (m/s) | Precipitation (mm) | ลักษณะสภาพอากาศ                                |
|---------|------------------|--------------|------------------|--------------------|-------------------------------------------------|
| 0       | 32.5             | 75.0         | 3.2              | 0.0                | ร้อนและชื้น |
| 1       | 26.0             | 85.0         | 6.5              | 2.5                | ฝนตกและลมแรง|
| 2       | 18.5             | 50.0         | 4.0              | 0.0                | เย็นและแห้ง|

## Benefit
**1. ด้านเทคนิค (Technical Benefits)**
- พัฒนาระบบ Data Pipeline ที่มีความเสถียร สามารถดึงข้อมูลและประมวลผลข้อมูลสภาพอากาศแบบเรียลไทม์ทุก 15 นาทีได้อย่างต่อเนื่อง

- การจัดเก็บข้อมูลด้วย LakeFS ช่วยให้สามารถติดตามและควบคุมเวอร์ชันของข้อมูลได้อย่างมีประสิทธิภาพ ลดความเสี่ยงจากข้อผิดพลาดของข้อมูล

- ใช้ Prefect ในการบริหาร Workflow ทำให้การจัดการกระบวนการดึงข้อมูลและการบันทึกข้อมูลเป็นไปโดยอัตโนมัติ พร้อมระบบ Retry และ Monitoring ที่ช่วยเพิ่มความน่าเชื่อถือของระบบ

- นำเสนอข้อมูลผ่าน Streamlit Dashboard ที่ตอบสนองรวดเร็วและมีความเสถียร เหมาะกับการใช้งานจริงในสถานการณ์ที่ต้องการข้อมูลอัปเดตทันที

- ประยุกต์ใช้ Machine Learning (K-Means Clustering) เพื่อเพิ่มมูลค่าในการวิเคราะห์และจำแนกข้อมูลสภาพอากาศได้อย่างมีประสิทธิภาพ

**2. ด้านการศึกษา (Educational Benefits)**
- เสริมสร้างความรู้และทักษะการใช้งานเทคโนโลยีที่ทันสมัย ได้แก่ Docker, Prefect, LakeFS, Streamlit และ Machine Learning สำหรับนักศึกษาและผู้พัฒนาที่ร่วมงาน

- เป็นตัวอย่างของการออกแบบและพัฒนาระบบ Big Data Infrastructure ที่ครบวงจร ตั้งแต่การดึงข้อมูล การจัดเก็บ ไปจนถึงการนำเสนอข้อมูล

- เพิ่มความเข้าใจในกระบวนการทำงานของ Data Pipeline, Workflow Orchestration และ Version Control สำหรับข้อมูลขนาดใหญ่

- ส่งเสริมการเรียนรู้เชิงปฏิบัติการผ่านการติดตั้งระบบจริงและการทำงานกับข้อมูลเรียลไทม์

- สนับสนุนการทำงานร่วมกันในทีมผ่านการใช้ GitHub และระบบ Version Control ที่เป็นมาตรฐาน

**3. ด้านการใช้งานจริง (Practical Benefits)**
- ช่วยให้สมาคมศิษย์เก่าสาธิตรามคำแหงและผู้ใช้งานในพื้นที่ใกล้เคียงสามารถเข้าถึงข้อมูลสภาพอากาศแบบเรียลไทม์ เพื่อวางแผนกิจกรรมหรือการเดินทางได้อย่างมีประสิทธิภาพและปลอดภัย

- Dashboard ที่ใช้งานง่าย ทำให้ผู้ใช้ทุกระดับสามารถดูข้อมูลสภาพอากาศย้อนหลังและปัจจุบันได้สะดวก พร้อมฟีเจอร์การวิเคราะห์เบื้องต้นผ่าน Machine Learning ช่วยตัดสินใจได้ดีขึ้น

- เพิ่มประสิทธิภาพในการบริหารจัดการข้อมูลสภาพอากาศสำหรับสมาคม รวมถึงเป็นฐานข้อมูลสำหรับวางแผนพัฒนาในอนาคต

- สามารถนำไปต่อยอดเป็นระบบแจ้งเตือนสภาพอากาศหรือระบบบริหารจัดการกิจกรรมที่สอดคล้องกับสภาพอากาศในอนาคต


## 5. บทสรุปของโครงการ (Project Summary)
โครงการระบบวิเคราะห์ข้อมูลสภาพอากาศแบบเรียลไทม์สำหรับสมาคมศิษย์เก่าสาธิตรามคำแหง ได้พัฒนาระบบ Data Pipeline ที่สามารถดึงข้อมูลสภาพอากาศจาก OpenWeatherMap API ในพื้นที่รอบสมาคมฯ และพื้นที่ใกล้เคียงจำนวน 15 จุด ทุก 15 นาที โดยใช้ Prefect ในการจัดการ Workflow อย่างอัตโนมัติ พร้อมจัดเก็บข้อมูลในรูปแบบ Parquet ผ่านระบบ version control ด้วย LakeFS 

ข้อมูลที่เก็บจะถูกนำมาแสดงผลบน Dashboard ด้วย Streamlit ที่ให้ผู้ใช้สามารถดูข้อมูลแบบเรียลไทม์และย้อนหลัง รวมถึงวิเคราะห์ข้อมูลด้วย K-Means Clustering เพื่อจำแนกและให้ภาพรวมของสภาพอากาศในแต่ละช่วงเวลาอย่างมีประสิทธิภาพ

โครงการนี้ไม่เพียงแต่ช่วยเสริมสร้างความรู้และทักษะในด้าน Data Engineering, Workflow Automation, และ Data Visualization แต่ยังตอบโจทย์การใช้งานจริงของชุมชนสมาคมศิษย์เก่า ด้วยการจัดเตรียมข้อมูลสภาพอากาศที่เชื่อถือได้และทันสมัย เพื่อสนับสนุนการวางแผนกิจกรรมและการตัดสินใจอย่างมีประสิทธิภาพในชีวิตประจำวัน

## วิธีการใช้งาน
**1.ติดตั้ง Docker และ Docker Compose บนเครื่องของคุณ**
**2.clone Project นี้** 
```bash
git clone https://github.com/Naynay07Nov/dsi321_2025.git
```
